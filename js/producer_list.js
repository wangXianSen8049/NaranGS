	...
	$.each(data.body.list, function(id, obj) {
	    ...
	    var $dom=$(
	    	"<tr>"+
	  			"<td></td>"+
	  			"<td>"+obj.farmName+"</td>"+
	  			"<td ><a style=color:"+colo+" href='Producer_xiang.html?farmId="+obj.farmId+"'>"+auditStatus+"</a></td>"+
	  			"<td>"+
	  				"<a class='a1' href='Producer_modify.html?farmId="+obj.farmId+"'>编辑</a>"+
	  				"<a class='a2' onclick=del\(this,'"+obj.farmId+"')\>删除</a>"+
	  			"</td>"+
  			"</tr>"); 
		$("table").append($dom);
